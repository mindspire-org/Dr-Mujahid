        ...
        <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4 items-end">
          <div className="grid gap-3 sm:grid-cols-2">
            <div>
              ...
              <input value={q} onChange={e=>{ setQ(e.target.value); setDiagPage(1); setLabPage(1) }} placeholder="Name, MRN, Token, Test" className="w-full rounded-md border border-slate-300 px-3 py-2 text-sm" />
            </div>
            <div>
              <label className="mb-1 block text-sm text-slate-700">Patient MRN</label>
              <input value={mrnFilter} onChange={e=>{ setMrnFilter(e.target.value); setDiagPage(1); setLabPage(1) }} placeholder="MRN" className="w-full rounded-md border border-slate-300 px-3 py-2 text-sm" />
            </div>
          </div>
          <div className="grid gap-3 sm:grid-cols-2">
            <div>
              <label className="mb-1 block text-sm text-slate-700">From</label>
              <input type="date" value={from} onChange={e=>{ setFrom(e.target.value); setDiagPage(1); setLabPage(1) }} className="w-full rounded-md border border-slate-300 px-3 py-2 text-sm" />
            </div>
            <div>
              <label className="mb-1 block text-sm text-slate-700">To</label>
              <input type="date" value={to} onChange={e=>{ setTo(e.target.value); setDiagPage(1); setLabPage(1) }} className="w-full rounded-md border border-slate-300 px-3 py-2 text-sm" />
            </div>
          </div>
          <div className="grid gap-3 sm:grid-cols-2">
            <div>
            ...
            <div>
              ...
              <select value={rows} onChange={e=>{ setRows(parseInt(e.target.value)||20); setDiagPage(1); setLabPage(1) }} className="w-full rounded-md border border-slate-300 px-3 py-2 text-sm">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <div>
              <label className="mb-1 block text-sm text-slate-700">My Referrals</label>
            ...
            {type !== 'lab' && (
              <div>
                <label className="mb-1 block text-sm text-slate-700">Diagnostic Status</label>
                <select value={diagStatus} onChange={e=>{ setDiagStatus(e.target.value as any); setDiagPage(1) }} className="w-full rounded-md border border-slate-300 px-3 py-2 text-sm">
                  <option value="all">All</option>
      ...
      {(type==='diagnostic' || type==='all') && (
        <div className="rounded-xl border border-slate-200 bg-white">
          <div className="flex items-center justify-between border-b border-slate-200 px-4 py-3 text-sm">
            <div className="font-medium text-slate-800">Diagnostic Results</div>
            <div className="text-slate-600">{diagTotal ? `${diagStart}-${diagEnd} of ${diagTotal}` : ''}</div>
          </div>
      ...
      {(type==='lab' || type==='all') && (
        <div className="rounded-xl border border-slate-200 bg-white">
          <div className="flex items-center justify-between border-b border-slate-200 px-4 py-3 text-sm">
            ...
            <div className="text-slate-600">{labTotal ? `${labStart}-${labEnd} of ${labTotal}` : ''}</div>
          </div>
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead className="border-b border-slate-200 bg-slate-50 text-left text-slate-600">

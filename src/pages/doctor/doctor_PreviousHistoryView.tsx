          ...
          <div className="space-y-4">
            <div className="grid gap-3 sm:grid-cols-2">
              <div className="rounded-lg border border-slate-200 bg-slate-50 p-3">
                ...
                <div className="text-sm font-semibold text-slate-900">{String(row?.hxBy || data?.hxBy || '-')}</div>
              </div>
              <div className="rounded-lg border border-slate-200 bg-slate-50 p-3">
                <div className="text-xs text-slate-500">Hx Date</div>
                <div className="text-sm font-semibold text-slate-900">{String(row?.hxDate || data?.hxDate || '-')}</div>
              </div>
            </div>

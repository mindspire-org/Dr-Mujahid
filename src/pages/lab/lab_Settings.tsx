...
export default function Lab_Settings() {
  ...
  const [reportTemplate, setReportTemplate] = useState<'classic'|'tealGradient'>('classic')
  ...
  useEffect(()=>{
    ...
    ;(async()=>{
      try {
        ...
        setReportTemplate((s.reportTemplate === 'tealGradient' ? 'tealGradient' : 'classic'))
        ...
        <div className="rounded-xl border border-slate-200 bg-white">
          ...
          <div className="space-y-4 p-4">
            ...
            <div>
              ...
              <select value={reportTemplate} onChange={e=> setReportTemplate((e.target.value as 'classic'|'tealGradient') || 'classic')} className="w-full rounded-md border border-slate-300 px-3 py-2 text-sm">

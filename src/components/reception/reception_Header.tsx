    ...
    >
      <div className="flex h-full items-center">
        ...
        <div className="flex h-full flex-1 items-center gap-0 px-3 sm:px-5">
          ...
          <Link to="/reception" className="ml-3 flex min-w-0 items-center gap-2">
          ...
          <div className="ml-auto flex items-center gap-3 text-sm">
            ...
            <div className="rounded-md border border-white/15 px-3 py-1.5 text-white">{user?.username || 'reception'}</div>
          </div>
        </div>
      </div>

...
export default function Pharmacy_AddInvoicePage() {
  ...
  const refreshCompanies = async (distId: string) => {
    const res: any = await pharmacyApi.listCompanies({ distributorId: distId })
    const list = res?.items ?? res ?? []
    setCompanies(list)
    return list as any[]
  }
              ...
              <div className="p-6">
                ...
                <div className="space-y-3 max-h-[60vh] overflow-y-auto">
                  ...
                  {items.map((row, idx) => (
                    ...
                    <div key={row.id} className={`rounded-lg border ${row.collapsed ? 'border-slate-200 bg-slate-50' : 'border-indigo-200 bg-white'} p-4`}>
                      ...
                      {row.collapsed ? (
                        ...
                        <div className="flex items-center justify-between gap-4">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-indigo-100 text-indigo-700 text-xs font-bold">#{idx + 1}</span>

                              <div>

                                <p className="font-medium text-slate-900 truncate">{row.name || 'Unnamed'}</p>

                                <p className="text-sm text-slate-500">{row.packs || 0} packs × PKR {row.buyPerPack || 0}</p>
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm font-semibold text-indigo-600">PKR {((row.buyPerPack || 0) * (row.packs || 0)).toFixed(2)}</span>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <span className="text-sm font-medium text-indigo-600">Item #{idx + 1}</span>
                          ...
                          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                                ...
                                <div className="absolute z-50 mt-1 w-full rounded-lg border border-slate-200 bg-white shadow-lg max-h-48 overflow-y-auto">
                                  ...
                                  {suggestions.map((sug) => (
                                    ...
                                    <button
                                      ...
                                      className="w-full px-3 py-2 text-left text-sm hover:bg-slate-50 last:border-0"
                            ...
                            <div>
                              ...
                              <label className="mb-2 block text-sm font-medium text-slate-700">Generic Name</label>
                            ...
                            <div>
                              ...
                              <label className="mb-2 block text-sm font-medium text-slate-700">Qty (Packs) *</label>
                            ...
                            <div>
                              ...
                              <label className="mb-2 block text-sm font-medium text-slate-700">Units/Pack *</label>
                            ...
                            <div>
                              ...
                              <label className="mb-2 block text-sm font-medium text-slate-700">Buy/Pack *</label>
                            ...
                            <div>
                              ...
                              <label className="mb-2 block text-sm font-medium text-slate-700">Sale/Pack *</label>
                            ...
                            <div>
                              ...
                              <label className="mb-2 block text-sm font-medium text-slate-700">Buy/Unit</label>
                            ...
                            <div>
                              ...
                              <label className="mb-2 block text-sm font-medium text-slate-700">Sale/Unit</label>
                            ...
                            <div>
                              ...
                              <label className="mb-2 block text-sm font-medium text-slate-700">Min Stock</label>
                            ...
                            <div>
                              ...
                              <label className="mb-2 block text-sm font-medium text-slate-700">Default Discount (%)</label>
                            ...
                            <div className="lg:col-span-3">
                              ...
                              <label className="mb-2 block text-sm font-medium text-slate-700">Line Tax (Optional)</label>
                              ...
                              <div className="flex gap-2">
                                ...
                                <select
                                  ...
                                  className="w-20 rounded-lg border border-slate-300 px-2 py-2 text-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200"
                                ...
                                <input
                                  ...
                                  className="flex-1 rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200"
                          ...
                          <div className="flex items-center justify-between rounded-lg bg-slate-50 px-4 py-3">
                            ...
                            <span className="font-semibold text-slate-900">PKR {((row.buyPerPack || 0) * (row.packs || 0)).toFixed(2)}</span>
                ...
                <div className="border-t border-slate-200">
                  ...
                  <div className="p-6 space-y-3">
                      ...
                      <div key={t.id} className="space-y-2">
                        ...
                        <div className="grid gap-2 sm:grid-cols-4">
                          ...
                          <button
                            ...
                            className="w-full rounded-lg px-3 py-2 text-sm font-medium text-rose-600 hover:bg-rose-50"
                    ...
                    <button
                      ...
                      className="w-full inline-flex items-center justify-center gap-2 rounded-lg border-2 border-dashed border-slate-300 px-4 py-2 text-sm font-medium text-slate-600 hover:border-indigo-400 hover:text-indigo-600"
            ...
            <div className="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-xl shadow-sm border border-emerald-200">
              ...
              <div className="px-6 pb-6 space-y-3">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium text-emerald-900">PKR {gross.toFixed(2)}</span>

                </div>

                <div className="flex justify-between text-sm">

                  <span className="text-emerald-700">Line Taxes:</span>

                  <span className="font-medium text-emerald-900">PKR {lineTaxesTotal.toFixed(2)}</span>

                </div>

                <div className="flex justify-between text-sm">

                  <span className="text-emerald-700">Invoice Taxes:</span>

                  <span className="font-medium text-emerald-900">PKR {invoiceTaxesTotal.toFixed(2)}</span>

                </div>

                <div className="flex justify-between pt-3 border-t border-emerald-300">

                  <span className="text-lg font-bold text-emerald-800">Net Total:</span>

                  <span className="text-xl font-black text-emerald-900">PKR {netTotal.toFixed(2)}</span>

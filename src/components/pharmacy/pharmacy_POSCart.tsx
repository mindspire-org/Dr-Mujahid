...
export default function Pharmacy_POSCart({ cart, products, productIndex, currency = 'PKR', onInc, onDec, onRemove, onClear, onSetQty, onQtyEnter, onSetLineDiscountPct }: Props) {
  return (
          ...
          return (
            <div key={line.id} className="flex items-center gap-3 p-4">
              <div className="flex-1">
                ...
                <div className="text-xs text-slate-500 dark:text-slate-400">{currency} {Number((p?.unitPrice ?? line.unitPrice) || 0).toFixed(2)} each</div>

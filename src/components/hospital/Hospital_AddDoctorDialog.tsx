      ...
      <div className="w-full max-w-2xl overflow-hidden rounded-xl border border-slate-200 bg-white shadow-lg">
        ...
        <div className="max-h-[80vh] overflow-y-auto px-5 py-4">
          ...
          <div>
            ...
            <input autoComplete="off" value={form.cnic} onChange={e=>update('cnic', e.target.value)} placeholder="13-digit CNIC (no dashes)" className="w-full rounded-md border border-slate-300 px-3 py-2 outline-none focus:border-violet-500 focus:ring-2 focus:ring-violet-200" />
          </div>
          <div>
          ...
          <div>
            ...
            <input autoComplete="off" value={form.username} onChange={e=>update('username', e.target.value)} placeholder="Enter username" className="w-full rounded-md border border-slate-300 px-3 py-2 outline-none focus:border-violet-500 focus:ring-2 focus:ring-violet-200" />
          </div>

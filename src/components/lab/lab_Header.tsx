...
export default function Lab_Header({ onToggleSidebar, collapsed, onToggleTheme, theme }: { onToggleSidebar?: ()=>void; collapsed?: boolean; onToggleTheme?: ()=>void; theme?: 'light'|'dark' }) {
  return (
    <header
    ...
    >
      <div className="flex h-full items-center">
        ...
        <div className="flex h-full flex-1 items-center gap-0 px-3 sm:px-5">
          ...
          <Link to="/lab" className="ml-3 flex items-center gap-2">
            ...
            <div className="font-semibold text-white">Lab</div>
          ...
          <div className="ml-auto flex items-center gap-3 text-sm">
            ...
            <button
              ...
              className="hidden rounded-md border border-white/15 px-3 py-1.5 text-white hover:bg-white/10 sm:flex items-center gap-2"
            >

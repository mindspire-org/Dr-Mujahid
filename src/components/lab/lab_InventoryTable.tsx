  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white">
      ...
      <div className="overflow-x-auto">
        <table className="min-w-[980px] text-left text-xs sm:min-w-full sm:text-sm">
      ...
      <div className="flex flex-col gap-2 border-t border-slate-200 px-4 py-3 text-sm text-slate-600 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-2">
          <button className="w-full rounded-md border border-slate-200 px-2 py-1 hover:bg-slate-50 sm:w-auto">Prev</button>
          <button className="w-full rounded-md border border-slate-200 px-2 py-1 hover:bg-slate-50 sm:w-auto">Next</button>
        </div>
      </div>
    </div>
  )

    ...
    <div class="wrap">
      ...
      <div class="box">
        <div class="kv">
          ...
          <div>Collection DatTime:</div><div>${fmtDateTime(input.sampleTime || input.createdAt)}</div>
          <div>Report DateTime:</div><div>${fmtDateTime(input.reportingTime || input.createdAt)}</div>

...
export async function previewLabReportPdfGradient(input: LabReportInput){
  ...
  drawKV('Collection DatTime:', String(fmtDateTime(input.sampleTime || input.createdAt)), L, y)
  drawKV('Report DateTime:', String(fmtDateTime(input.reportingTime || input.createdAt)), R, y); y += 14

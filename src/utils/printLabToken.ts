...
export async function printLabTokenSlip(order: LabSlipOrderInput){
  ...
  <style>
    ...
    .slip-card{width:min(384px, 100%);max-width:100%;max-height:calc(100vh - 32px);overflow:auto;background:#fff;border-radius:12px;box-shadow:0 10px 25px rgba(2,6,23,0.2)}
    .toolbar{display:flex;flex-wrap:wrap;justify-content:space-between;align-items:center;gap:8px;padding:10px 12px;border-bottom:1px solid #e2e8f0;background:#f8fafc}

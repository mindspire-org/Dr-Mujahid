...
export const hospitalApi = {
  ...
  createHospitalUser: (data: { username: string; role: 'Admin'|'Staff'|'Reception'|'Doctor'|'Finance'; fullName?: string; phone?: string; email?: string; password?: string; active?: boolean }) =>
    api('/hospital/users', { method: 'POST', body: JSON.stringify(data) }),
  updateHospitalUser: (id: string, data: { username?: string; role?: 'Admin'|'Staff'|'Reception'|'Doctor'|'Finance'; fullName?: string; phone?: string; email?: string; password?: string; active?: boolean }) =>
  ...
  // Prescriptions
  createPrescription: (data: { encounterId: string; items: Array<{ name: string; dose?: string; frequency?: string; duration?: string; notes?: string }>; labTests?: string[]; labNotes?: string; diagnosticTests?: string[]; diagnosticNotes?: string; therapyTests?: string[]; therapyNotes?: string; primaryComplaint?: string; primaryComplaintHistory?: string; familyHistory?: string; treatmentHistory?: string; allergyHistory?: string; history?: string; examFindings?: string; diagnosis?: string; advice?: string; createdBy?: string; vitals?: { pulse?: number; temperatureC?: number; bloodPressureSys?: number; bloodPressureDia?: number; respiratoryRate?: number; bloodSugar?: number; weightKg?: number; heightCm?: number; bmi?: number; bsa?: number; spo2?: number } }) =>
  ...
  updatePrescription: (id: string, data: { items?: Array<{ name: string; dose?: string; frequency?: string; duration?: string; notes?: string }>; labTests?: string[]; labNotes?: string; diagnosticTests?: string[]; diagnosticNotes?: string; therapyTests?: string[]; therapyNotes?: string; primaryComplaint?: string; primaryComplaintHistory?: string; familyHistory?: string; treatmentHistory?: string; allergyHistory?: string; history?: string; examFindings?: string; diagnosis?: string; advice?: string; vitals?: { pulse?: number; temperatureC?: number; bloodPressureSys?: number; bloodPressureDia?: number; respiratoryRate?: number; bloodSugar?: number; weightKg?: number; heightCm?: number; bmi?: number; bsa?: number; spo2?: number } }) =>

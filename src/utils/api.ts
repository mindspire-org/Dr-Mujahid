...
export const therapyApi = {
  ...
  recordPayment: (data: { patientId: string; visitId?: string; amount: number; applyMode?: 'duesFirst' | 'advanceOnly' | 'duesOnly'; note?: string }) =>
    api('/therapy/payments', { method: 'POST', body: JSON.stringify(data) }),
}
...
export const hospitalApi = {
  ...
  // Prescriptions
  createPrescription: (data: { encounterId: string; historyTakingId?: string; labReportsEntryId?: string; medicine?: Array<{ name: string; dose?: string; frequency?: string; duration?: string; notes?: string }>; items?: Array<{ name: string; dose?: string; frequency?: string; duration?: string; notes?: string }>; labTests?: string[]; labNotes?: string; diagnosticTests?: string[]; diagnosticNotes?: string; therapyTests?: string[]; therapyNotes?: string; therapyPlan?: any; therapyMachines?: any; counselling?: any; primaryComplaint?: string; primaryComplaintHistory?: string; familyHistory?: string; treatmentHistory?: string; allergyHistory?: string; history?: string; examFindings?: string; diagnosis?: string; advice?: string; createdBy?: string; vitals?: { pulse?: number; temperatureC?: number; bloodPressureSys?: number; bloodPressureDia?: number; respiratoryRate?: number; bloodSugar?: number; weightKg?: number; heightCm?: number; bmi?: number; bsa?: number; spo2?: number } }) =>
  ...
  upsertPrescriptionByEncounter: (encounterId: string, data: { historyTakingId?: string; labReportsEntryId?: string; medicine?: Array<{ name: string; dose?: string; frequency?: string; duration?: string; notes?: string }>; items?: Array<{ name: string; dose?: string; frequency?: string; duration?: string; notes?: string }>; labTests?: string[]; labNotes?: string; diagnosticTests?: string[]; diagnosticNotes?: string; therapyTests?: string[]; therapyNotes?: string; therapyPlan?: any; therapyMachines?: any; counselling?: any; primaryComplaint?: string; primaryComplaintHistory?: string; familyHistory?: string; treatmentHistory?: string; allergyHistory?: string; history?: string; examFindings?: string; diagnosis?: string; advice?: string; createdBy?: string; vitals?: { pulse?: number; temperatureC?: number; bloodPressureSys?: number; bloodPressureDia?: number; respiratoryRate?: number; bloodSugar?: number; weightKg?: number; heightCm?: number; bmi?: number; bsa?: number; spo2?: number } }) =>

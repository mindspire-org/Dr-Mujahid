...
export const counsellingAppointmentCreateSchema = z.object({
...
export const counsellingAppointmentUpdateSchema = counsellingAppointmentCreateSchema.partial().extend({
  patientName: z.string().min(1).optional(),
  appointmentDate: z.string().min(1).optional(),
})

export const counsellingAppointmentQuerySchema = z.object({
  q: z.string().optional(),
